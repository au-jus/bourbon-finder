...
def lambda_handler(event, context):
    ...
    result = f"Stores and Products allocated in Des Moines:\n{local_string} \n\n\nAll other locations in Iowa:\n{other_string}"
    print(result)
    client_response = client.publish(TopicArn='arn:aws:sns:us-east-1:{ACCOUNT_ID}:bourbon-notification', Message=result)
